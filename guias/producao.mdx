...
use Suot\Fiscal\Cte\Operation\Issue\IssueCteResult;
use Suot\Fiscal\Core\Exception\InfrastructureException;
use Psr\Log\LoggerInterface;

final class IssueCteService
{
    public function __construct(
        private readonly IssueCteHandler $handler,
        private readonly LoggerInterface $logger,
    ) {}

    public function issue(IssueCteCommand $command): IssueCteResult
    {
        try {
